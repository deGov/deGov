...
function nrwgov_profile_install_tasks($install_state) {
  $tasks = array(
    'nrwgov_base_setup' => array(
      'display_name' => t('Install nrwGov base'),
      'type' => 'batch'
    ),
...
//      'display' => TRUE,
//    ),
//    'nrwgov_media_setup' => array(
//      'display_name' => t('Install nrwGov media'),
//      'type' => 'batch'
//    ),
//    'nrwgov_paragraphs_setup' => array(
//      'display_name' => t('Install nrwGov paragraphs'),
//      'type' => 'batch'
//    ),
//    'nrwgov_node_setup' => array(
//      'display_name' => t('Install nrwGov node'),
//      'type' => 'batch'
//    ),
//    'nrwgov_search_setup' => array(
//      'display_name' => t('Install nrwGov search'),
//      'type' => 'batch'
//    ),
...
/**
 * Install nrwGov base task.
 *
 * Install all required base nrwGov base modules as an additional step.
 */
function nrwgov_base_setup(&$install_state) {
...
/**
 * Install nrwGov media task.
 *
 * Install all required base nrwGov media modules as an additional step.
 */
function nrwgov_media_setup(&$install_state) {
  // Prevent Drupal status messages during profile installation.
  drupal_get_messages('status', TRUE);
...
/**
 * Install nrwGov paragraphs task.
 *
 * Install all required base nrwGov paragraph modules as an additional step.
 */
function nrwgov_paragraphs_setup(&$install_state) {
  // Prevent Drupal status messages during profile installation.
  drupal_get_messages('status', TRUE);
...
/**
 * Install nrwGov node modules task.
 *
 * Install all required base nrwGov node modules.
 */
function nrwgov_node_setup(&$install_state) {
  // Prevent Drupal status messages during profile installation.
  drupal_get_messages('status', TRUE);
...
/**
 * Install nrwGov search modules task.
 *
 * Install all required base nrwGov search modules.
 */
function nrwgov_search_setup(&$install_state) {
  // Prevent Drupal status messages during profile installation.
  drupal_get_messages('status', TRUE);
